"""
Weave help screen - keyboard shortcuts and usage information.
"""
...
If focus is on the prompt input box on the home screen, `esc` will close Weave too.

### Local LLM Setup

Weave uses a local LLM via llama.cpp. Make sure you have:
1. Downloaded a compatible GGUF model
2. Configured the model path in your settings

See the implementation guide for detailed setup instructions.

### General navigation

Weave has very strong mouse support. Most things can be clicked.
...
"""
    ...
    def compose(self) -> ComposeResult:
        with Vertical(id="help-container") as vertical:
            vertical.border_title = "Weave Help"
            with VerticalScroll():
